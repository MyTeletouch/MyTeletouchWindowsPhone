...
namespace MyTeletouch
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            ChangeActivePage(ActivePageType.Keyboard);
        }
        ...
        private void ButtonJoystick_Click(object sender, RoutedEventArgs e)
        {
            ChangeActivePage(ActivePageType.Joystick);
        }
        ...
        private void ChangeActivePage(ActivePageType newPageType)
        {
            ...
            switch (newPageType)
            {
                ...
                case ActivePageType.Mouse:
                    ...
                    DisplayInformation.AutoRotationPreferences = DisplayOrientations.None;
                    //this.MouseControl.Initialize(newPageType);
                    break;
